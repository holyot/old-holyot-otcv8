-- CONFIG
APP_NAME = "HolyOT_Desktop"  -- important, change it, it's name for config dir and files in appdata
...
Services = {
  ...
  updater = "http://updater.holyot.org/otcv8-updater/desktop/updater.php",
  stats = "http://updater.holyot.org/otcv8-updater/stats.php",
  crash = "http://otclient.ovh/api/crash.php",
  feedback = "http://otclient.ovh/api/feedback.php",
  status = "http://updater.holyot.org/otcv8-updater/status.php"
}

-- Servers accept http login url, websocket login url or ip:port:version
Servers = {
  OTClientV8 = "login.holyot.org:7173:860",
}

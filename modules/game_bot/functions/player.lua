...
context.pos = function() return context.player:getPosition() or 0 end
context.posx = function() return context.player:getPosition().x or 0 end
context.posy = function() return context.player:getPosition().y or 0 end
context.posz = function() return context.player:getPosition().z or 0 end
